    ...
    <div className="space-y-12 animate-fade-in" id="about-view">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-2">
          <div className="lg:col-span-8 text-slate-600 gap-y-4 flex flex-col text-sm leading-relaxed">
            ...
            <p className="font-medium text-slate-700">
              Vid eventuella frågor eller förfrågningar om lediga lokaler, är du alltid varmt välkommen att maila eller ringa oss!
            </p>
          </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-xs p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          ...
          <div className="p-4 rounded-xl border border-slate-50 bg-slate-50/50 space-y-2">
            <h3 className="font-bold text-slate-800 text-sm">Leif Mansor</h3>
