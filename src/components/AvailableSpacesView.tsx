...
interface AvailableSpacesViewProps {
  ...
  onEditSpace?: (space: VacantSpace) => void;
}
          ...
          <div className="space-y-6" id="seo-tab-lediga-lokaler">
              ...
              <div className="space-y-4 pt-2">
                ...
                {spaces.length === 0 ? (
                  <div className="bg-slate-50 border border-slate-100 p-8 rounded-2xl text-center space-y-3">
                    ...
                    <div>
                      <p className="font-bold text-sm sm:text-base text-slate-700">Inga lediga lokaler listade just nu</p>
                      ...
                      >
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="flex-grow space-y-4">
                            <div>
                              ...
                              <p className="text-sm sm:text-base text-slate-650 mt-2 leading-relaxed">
                                {space.description}
                              </p>
                            </div>
                            ...
                            {space.suitableFor && space.suitableFor.length > 0 && (
                              <div className="space-y-1.5">
                                ...
                                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-sm text-slate-650">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-slate-100">
                          <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100/50 space-y-1">
                            <span className="text-[10px] sm:text-xs font-bold text-slate-450 uppercase tracking-wider block">Total Area</span>
                            <p className="text-sm font-semibold text-slate-800 leading-normal">{space.totalArea}</p>
                          </div>

                          <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100/50 space-y-1">
                            <span className="text-[10px] sm:text-xs font-bold text-slate-450 uppercase tracking-wider block font-mono">Nedre Plan (Tak &amp; Port)</span>
                            <p className="text-sm font-semibold text-slate-700 leading-normal">{space.detailsLowerLevel}</p>
                          </div>

                          <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100/50 space-y-1">
                            <span className="text-[10px] sm:text-xs font-bold text-slate-450 uppercase tracking-wider block">Övre Plan</span>
                            <p className="text-sm font-semibold text-slate-700 leading-normal">{space.detailsUpperLevel}</p>
                          </div>
                        </div>
                          ...
                          {role === "Administrator" && (
                            <div className="flex gap-2 shrink-0">
                              <button
                                ...
                                className="px-3.5 py-1.5 text-amber-650 hover:bg-amber-50 text-xs font-bold rounded-lg border border-amber-200 hover:border-amber-300 transition flex items-center gap-1 cursor-pointer"
                              >
                              ...
                              <button
                                ...
                                className="px-3.5 py-1.5 text-rose-600 hover:bg-rose-50 text-xs font-bold rounded-lg border border-rose-100 hover:border-rose-200 transition flex items-center gap-1 cursor-pointer"
                              >
            ...
            <div className="space-y-6" id="seo-tab-kontorshotell">
              ...
              <div className="bg-slate-50 border border-slate-100 p-6 rounded-2xl space-y-4">
                <h4 className="font-bold text-slate-800 text-sm uppercase tracking-wider">Bekräftad information för övre plan:</h4>
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4 text-sm">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-white focus:outline-none focus:ring-1 focus:ring-amber-500"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                {spaces.length > 0 ? (
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-white cursor-pointer focus:outline-none focus:ring-1 focus:ring-amber-500"
                  >
                  ...
                  <select
                    ...
                    disabled
                    className="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-slate-400 opacity-80"
                  >
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-800 border border-slate-700 rounded-lg text-sm text-white resize-none focus:outline-none focus:ring-1 focus:ring-amber-500"
                />
              </div>
              ...
              <button
                ...
                className={`w-full py-3 text-slate-950 font-bold block text-sm rounded-lg transition-colors cursor-pointer text-center uppercase tracking-wide border shadow-sm ${
                  isSubmitting 
